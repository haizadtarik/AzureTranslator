...
# =========== Setup bot ============
TOKEN = '923909824:AAEUdNNImgmK5hr_YoKnvP49NjnEBqgvjDw'
bot = "https://api.telegram.org/bot"+TOKEN+"/"
file_url = 'https://api.telegram.org/file/bot'+TOKEN+'/'

# =========== Setup CV client ============
endpoint = 'https://jat-vision.cognitiveservices.azure.com/'
key = '688c0e5b682b44f59231bc38eef1af7c'
credentials = CognitiveServicesCredentials(key)
client = ComputerVisionClient(endpoint, credentials)

# =========== Setup translator client ============
subscriptionKey = 'e63c4d1c95cf44bfbddd305cf8dad9cc'
base_url = 'https://api.cognitive.microsofttranslator.com/translate?api-version=3.0'
languages = {'ar':'arabic', 'zh-Hans':'chinese', 'en':'english', 'ja':'japanese', 'pt':'portuguese','es':'spanish'}
headers = {
